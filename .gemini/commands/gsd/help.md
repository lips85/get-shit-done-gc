...
- Summarizes recent work and displays current position
...
- Extracts deliverables from SUMMARY.md
- Generates test checklist and guides the process
- Logs issues to phase-scoped ISSUES.md

Usage: `/gsd:verify-work` or `/gsd:verify-work 4`

**`/gsd:plan-fix [plan]`**
Plan fixes for UAT issues found during verify-work.

- Reads phase-scoped ISSUES.md
- Creates FIX.md plan ready for execution
