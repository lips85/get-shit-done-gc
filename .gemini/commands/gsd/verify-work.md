...
Purpose: Validate that what Gemini thinks was built actually works from the user's perspective. The USER performs all testing — Gemini generates the test checklist, guides the process, and captures issues.
...
@./.gemini/get-shit-done/templates/uat-issues.md
</execution_context>
