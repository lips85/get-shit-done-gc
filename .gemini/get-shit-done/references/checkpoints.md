...
<task type="checkpoint:human-action" gate="blocking">
  ...
  <instructions>[What Gemini automated] [ONE thing requiring human action]</instructions>
  <verification>[What Gemini checks afterward]</verification>
...
<!-- After auth, Gemini retries automatically -->
<task type="auto">
...
**DON'T:**
- Ask human to do work Gemini can automate
...
**GOOD: Gemini automates, human verifies once**
```xml
<task type="auto">Create schema</task>
<task type="auto">Create API</task>
...
**Checkpoint priority:**
1. **checkpoint:human-verify** (90%) - Gemini automated, human confirms visual/functional correctness
2. **checkpoint:decision** (9%) - Human makes architectural/technology choices
3. **checkpoint:human-action** (1%) - Truly unavoidable manual steps with no API/CLI

**When NOT to use checkpoints:**
- Things Gemini can verify programmatically (tests, builds)
- File operations (Gemini can read/write)
