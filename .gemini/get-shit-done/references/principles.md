...
**Git commits = context engineering for Gemini.**
...
- Git history becomes primary context source for future Gemini sessions
...
See `./.gemini/get-shit-done/references/git-integration.md` for complete strategy.
</atomic_commits>
