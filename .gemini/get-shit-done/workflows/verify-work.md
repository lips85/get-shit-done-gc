...
The USER performs all testing — Gemini generates the checklist, guides the process, and captures issues.
</purpose>
...
2. Use template from `@./.gemini/get-shit-done/templates/uat-issues.md`
3. Add each issue:
